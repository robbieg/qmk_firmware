...
#define SP_LGUI MT(MOD_LGUI, KC_SPC)
#define SP_RGUI MT(MOD_RGUI, KC_SPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi_blocker(
        ...
        MO(1)  , KC_LALT, SP_LGUI,                            KC_SPC,                             SP_RGUI, KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT_65_ansi_blocker(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, MD_BOOT,
        ...
        _______, RGB_TOG, _______, _______, _______, MD_BOOT, NK_TOGG, DBG_TOG, KC_BTN1, KC_BTN2, _______, _______,          KC_MS_U, KC_VOLD,
